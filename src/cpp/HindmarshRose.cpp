...
HindmarshRose::HindmarshRose(double time_increment, const char *filename,
                             int elements_in_model, float initial_x, float e,
                             float m, float S)
    : Model(time_increment, filename, elements_in_model) {
  this->x = initial_x;
...
HindmarshRose::HindmarshRose(double time_increment, const char *filename,
                             int elements_in_model, float initial_x,
                             float initial_y, float initial_z, float e, float m,
                             float S)
    : Model(time_increment, filename, elements_in_model) {
  this->x = initial_x;
  this->y = initial_y;
...
HindmarshRose::HindmarshRose(double time_increment, const char *filename,
                             int elements_in_model, float initial_x,
                             float initial_yz, float e, float m, float S,
                             StationaryMode mode)
    : Model(time_increment, filename, elements_in_model) {
  this->x = x;
...
HindmarshRose::HindmarshRose(float start_time, double time_increment,
                             const char *filename, int elements_in_model,
                             float initial_x, float e, float m, float S)
    : Model(time_increment, filename, elements_in_model, start_time) {
  this->x = initial_x;
...
HindmarshRose::HindmarshRose(float start_time, double time_increment,
                             const char *filename, int elements_in_model,
                             float initial_x, float initial_yz, float e,
                             float m, float S, StationaryMode mode)
    : Model(time_increment, filename, elements_in_model, start_time) {
  this->x = x;
